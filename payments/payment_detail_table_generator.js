    ...
    $('#'.concat(table_id)).bootstrapTable(
        {
            ...
            columns: [
                ...
                },
                {
                    ...
                    title: 'To Date<br>Amount<br>SIP',
                    align: 'center',
                ...
                },
                {
                    ...
                    title: 'Allocated<br>Amount<br>SIP',
                    align: 'center',
                ...
                {
                    field: 'payment_details.period.qty.fol'.concat('.', pp_number),
                    title: 'Period<br>QTY<br>FOL',
                    align: 'center',
                    formatter: qty_formatter_with_dec,
                    visible: turn_on_fol[0][0]
                },
                {
                    field: 'payment_details.period.amt.fol'.concat('.', pp_number),
                    title: 'Period<br>Amount<br>FOL',
                    align: 'center',
                    class: 'period_amt_fol',
                    formatter: dollar_formatter_accounting,
                    footerFormatter: function () {
                        return '<b>'.concat(
                            dollar_formatter_accounting(base_sov_totals_obj.payment_details.period.amt.fol[pp_number]),
                            '<b>')
                    },
                    visible: turn_on_fol[0][1]
                },
                {
                    field: 'payment_details.todate.qty.fol'.concat('.', pp_number),
                    title: 'To Date<br>QTY<br>FOL',
                    align: 'center',
                    formatter: qty_formatter_with_dec,
                    visible: turn_on_fol[1][0]
                },
                {
                    field: 'payment_details.todate.amt.fol'.concat('.', pp_number),
                    title: 'To Date<br>Amount<br>FOL',
                    align: 'center',
                    class: 'todate_amt_fol',
                    formatter: dollar_formatter_accounting,
                    footerFormatter: function () {
                        return '<b>'.concat(
                            dollar_formatter_accounting(base_sov_totals_obj.payment_details.todate.amt.fol[pp_number]),
                            '<b>')
                    },
                    visible: turn_on_fol[1][1]
                },
                {
                    field: 'payment_details.allctd.qty.fol',
                    title: 'Allocated<br>QTY<br>FOL',
                    align: 'center',
                    formatter: qty_formatter_with_dec,
                    visible: turn_on_fol[2][0]
                },
                {
                    field: 'payment_details.allctd.amt.fol',
                    title: 'Allocated<br>Amount<br>FOL',
                    align: 'center',
                    class: 'allctd_amt_fol',
                    formatter: dollar_formatter_accounting,
                    footerFormatter: function () {
                        return '<b>'.concat(
                            dollar_formatter_accounting(base_sov_totals_obj.payment_details.allctd.amt.fol),
                            '<b>')
                    },
                    visible: turn_on_fol[2][1]
                }
