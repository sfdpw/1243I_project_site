...
//        '03': 'Concrete',
    ...
    for (ii = 0; ii < list_of_specs.length; ii++) {
        ...
        if (active_div_list.includes(list_of_specs[ii].substring(11, 13)) == false) {

            active_div_list.push(list_of_specs[ii].substring(11, 13));
    ...
    for (ii = 0; ii < active_div_list.length; ii++) {
        ...
        for (var jj = 0; jj < list_of_specs.length; jj++) {
            ...
            if (list_of_specs[jj].substring(11, 13) == active_div_list[ii]) {

                return_block += '<a href="' + list_of_specs[jj] + '" target="_blank">' +
                    ((list_of_specs[jj].replace(".pdf", "")).replace('1243I_spec_','')).replace(/_/g,' ') + '</a><br>';
    ...
    return_block +=
        ...
        '<div style="font-size: small" class="card">\
            ...
            <div id="collapse_' + 'SPEC_GEN' + '"\
                 ...
                 data-parent="#accordion">\
              <div style="max-height:140pt; overflow-y:scroll" class="card-body">\
                <a href=\"./1243I_Project_Manual_Vol_1_of_2.pdf\" target=\"_blank\">Project Specification Manual - Volume 1</a><br>\
                <a href=\"./1243I_Project_Manual_Vol_2_of_2.pdf\" target=\"_blank\">Project Specification Manual - Volume 2</a><br>\
                <a href=\"./1243I_Project_Manual_Complete_Conformed.pdf\" target=\"_blank\">Project Specification Manual - Complete, Conformed</a><br>\
